...
{
    public class OpenAdminWindowCommand : CommandBase
    {
        public override void Execute(object? parameter)
        {
            var window = ServiceLocator.GetService<AdministratorWindow>();

            window = new AdministratorWindow()
            {
                DataContext = ServiceLocator.GetService<AdministratorViewModel>()
            };
